...
import { StepBot, StepTelethon } from "./LegacyTelegramSteps";
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Two pieces: the bot that captures incoming leads, and the operator account that replies to them.
        </p>
      </div>
      {sub === 0 && <StepBot onDone={() => setSub(1)} onSkip={() => setSub(1)} />}
      {sub === 1 && <StepTelethon onDone={onNext} onSkip={onNext} />}
